...
## RETRIEVE, DO NOT READ — this file is 23KB (~6,444 tokens)
...
```
lab_search("<your symptom or question>", effort="srx-ipsec-hub-spoke")
```
...
do not silently read 23KB into context, and do not re-derive what is already written here.**
