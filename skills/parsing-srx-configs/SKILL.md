...
## RETRIEVE, DO NOT READ — this file is 29KB (~8,295 tokens)
...
```
lab_search("<your symptom or question>", effort="parsing-srx-configs")
```
...
do not silently read 29KB into context, and do not re-derive what is already written here.**
