...
## RETRIEVE, DO NOT READ — this file is 21KB (~5,883 tokens)
...
```
lab_search("<your symptom or question>", effort="srx-advpn")
```
...
do not silently read 21KB into context, and do not re-derive what is already written here.**
