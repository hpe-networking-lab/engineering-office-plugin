...
## RETRIEVE, DO NOT READ — this file is 33KB (~9,303 tokens)
...
```
lab_search("<your symptom or question>", effort="srx-policy")
```
...
do not silently read 33KB into context, and do not re-derive what is already written here.**
