...
| **aos8-to-aos10-central-migration** | Controller-managed AOS 8 campus APs to AOS 10 / New Central: entitlement, group + site gates, ap convert, config-model rebuild. | change, gated |
...
├── skills/<15 EO skills + 7 vendored SRX skills>/SKILL.md
